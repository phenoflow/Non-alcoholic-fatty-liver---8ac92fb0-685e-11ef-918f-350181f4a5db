...
(async () => {
  ...
  await fs.writeFile("non-alcoholic-fatty-liver-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("non-alcoholic-fatty-liver-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
